/**
 * Newsroom page hero — text-only dark surface that sits in the same
 ...
 * has no source set), so the surface stays flat `bg-primary-900`.
 */
export default function NewsroomHero() {
  return (
    <section
      aria-labelledby="newsroom-hero-heading"
      className="bg-primary-900 rounded-card relative mx-5 mt-5 overflow-hidden"
    >
      <div className="flex flex-col justify-end px-gutter md:px-10 lg:px-20 py-10 md:py-12 lg:py-20 h-[340px] md:h-[420px] lg:h-[500px]">
