      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-untitled-sans font-normal text-gray-900 mb-4">
              How Can We Help?
            </h2>
            <p className="text-xl font-untitled-sans text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactMethods.map((method, index) => (
              <div key={index} className="bg-gray-50 p-8 rounded-2xl hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-untitled-sans font-normal text-gray-900 mb-4">
                  {method.title}
                </h3>
                <p className="text-gray-600 mb-6 leading-relaxed font-untitled-sans">
                  {method.description}
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <PixonalIcon name="envelope" size={20} className="text-accent-blue" />
                    <a href={`mailto:${method.email}`} className="text-accent-blue hover:underline font-untitled-sans">
                      {method.email}
                    </a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <PixonalIcon name="phone" size={20} className="text-accent-blue" />
                    <a href={`tel:${method.phone}`} className="text-accent-blue hover:underline font-untitled-sans">
                      {method.phone}
                    </a>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {offices.map((office, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-shadow">
                <h3 className="text-2xl font-untitled-sans font-normal text-gray-900 mb-2">
                  {office.city}
                </h3>
                <p className="text-gray-600 mb-4 font-untitled-sans">
                  {office.country}
                </p>
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    <PixonalIcon name="map-pin" size={20} className="text-accent-blue mt-1" />
                    <span className="text-gray-700 font-untitled-sans">{office.address}</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <PixonalIcon name="phone" size={20} className="text-accent-blue" />
                    <a href={`tel:${office.phone}`} className="text-accent-blue hover:underline font-untitled-sans">
                      {office.phone}
                    </a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <PixonalIcon name="envelope" size={20} className="text-accent-blue" />
                    <a href={`mailto:${office.email}`} className="text-accent-blue hover:underline font-untitled-sans">
                      {office.email}
                    </a>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-untitled-sans text-gray-600">
          ...
          <div className="space-y-8">
            <div className="bg-gray-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-600 leading-relaxed font-untitled-sans">
